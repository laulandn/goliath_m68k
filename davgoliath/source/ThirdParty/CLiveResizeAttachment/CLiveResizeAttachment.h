...
Change history:
----- 1.0.2 -----
05/09/01	Conditionalised for correct behaviour on PowerPlant 2.2
----- 1.0.1 -----
...
*********** Usage *************
IMPORTANT: 
If you are using a PowerPlant earlier than 2.2 final,
you must first fix a "wart" in LEventHandler.
