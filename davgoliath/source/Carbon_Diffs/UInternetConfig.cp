// ===========================================================================
//	UInternetConfig.cp			PowerPlant 2.1		©1997-2000 Metrowerks Inc.
// ===========================================================================
//	
...
OSStatus
UInternetConfig::PP_ICParseURL(ConstStr255Param hint, 
								Ptr data, 
								SInt32 len, 
								SInt32 *selStart, 
								SInt32 *selEnd, 
...
OSStatus
UInternetConfig::PP_ICLaunchURL(ConstStr255Param hint, 
								Ptr data, 
								SInt32 len, 
								SInt32 *selStart, 
								SInt32 *selEnd)
										...
										Str255& outPassword)
{
	...
	char * atSign = strtok((char*)tempBuff, "@");
	if (atSign) {
		strcpy((char*)outUser, atSign);
		
		atSign = strtok(nil, "");
		strcpy((char*)outHost, atSign);
